...
{
    public class RPTTaxByWardController : Controller
    {
        ...
        #region Constructor
        public RPTTaxByWardController(IUnionParishadService unionParishadService, IFinancialYearService financialYearService, ITaxInstallmentService taxInstallmentService, IVillageInfoService villageInfoService, IWardInfoService wardInfoService)
        {
        ...
        public ActionResult Index(VMCommonParams commonParams)
        {
            ...
            List<VMWordOrVillWiseTaxReport> result = _taxInstallmentService.GetRPTTaxInfoByWord(commonParams.VillageInfoId, commonParams.WardInfoId, commonParams.FinancialYearId, _unionId);
            if (result.Count == 0)
            {
            ...
            reportViewer.LocalReport.ReportPath = Request.MapPath("~/Reports/RDLC/TaxInfoByWard.rdlc");
